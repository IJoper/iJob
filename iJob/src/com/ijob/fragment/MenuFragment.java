...
public class MenuFragment extends PreferenceFragment implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		findPreference("d").setOnPreferenceClickListener(this);// about us
		findPreference("e").setOnPreferenceClickListener(this);// exit
	}
	...
	public boolean onPreferenceClick(Preference preference) {
		...
		if ("a".equals(key)) {
			...
			FragmentManager fragmentManager = ((MainActivity) getActivity())
					.getFragmentManager();
			MainFragment contentFragment = (MainFragment) fragmentManager
					.findFragmentByTag("A");
			fragmentManager
					.beginTransaction()
					.replace(
							R.id.content,
							contentFragment == null ? new MainFragment()
			...
			FragmentManager fragmentManager = ((MainActivity) getActivity())
					.getFragmentManager();
			Personal contentFragment = (Personal) fragmentManager
					.findFragmentByTag("B");
			fragmentManager
					.beginTransaction()
					.replace(
							R.id.content,
							contentFragment == null ? new Personal()
									: contentFragment, "B").commit();
			...
			FragmentManager fragmentManager = ((MainActivity) getActivity())
					.getFragmentManager();
			HelpServerFragment contentFragment = (HelpServerFragment) fragmentManager
					.findFragmentByTag("C");
			fragmentManager
					.beginTransaction()
					.replace(
							R.id.content,
							contentFragment == null ? new HelpServerFragment()
									: contentFragment, "C").commit();
			...
			FragmentManager fragmentManager = ((MainActivity) getActivity())
					.getFragmentManager();
			AboutUs contentFragment = (AboutUs) fragmentManager
					.findFragmentByTag("D");
			fragmentManager
					.beginTransaction()
					.replace(
							R.id.content,
							contentFragment == null ? new AboutUs()
									: contentFragment, "D").commit();
